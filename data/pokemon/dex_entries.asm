...
SECTION "TreekoPokedexEntry", ROMX
TreekoPokedexEntry::
	db "Wood Gecko@"
	db   "Tiny hooks on its"
	next "feet allow it to"
	next "scale any wall"
	page "It will stare down"
	next "enemies not giving"
	next "an inch of ground@"

SECTION "GrovylePokedexEntry", ROMX
GrovylePokedexEntry::
	db "Wood Gecko@"
	db   "Master of the"
	next "jungle its leaves"
	next "camouflage it and"
	page "it swiftly leaps"
	next "through the"
	next "canopy and grace.@"

SECTION "SceptilePokedexEntry", ROMX
SceptilePokedexEntry::
	db "Forest@"
	db   "Its razor sharp"
	next "leaves make it"
	next "without equal in"
	page "the jungle where"
