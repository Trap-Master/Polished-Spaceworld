NewBarkTown_MapScriptHeader:
	...
	object_event 16, 12, SPRITE_FAT_GUY, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, jumptextfaceplayer, GivemndebugScript, -1
...
GivemndebugScript:
	...
	givepoke POOCHYENA, NO_FORM, 5, ORAN_BERRY;, SHINY_MASK
