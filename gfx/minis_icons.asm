...
SECTION "Treeko Mini Icon", ROMX
TreekoMini::     INCBIN "gfx/minis/treeko.2bpp.lz"
TreekoMiniMask:: INCBIN "gfx/minis/treeko_mask.1bpp.lz"
TreekoIcon::     INCBIN "gfx/icons/treeko.2bpp.lz"

SECTION "Grovyle Mini Icon", ROMX
GrovyleMini::     INCBIN "gfx/minis/grovyle.2bpp.lz"
GrovyleMiniMask:: INCBIN "gfx/minis/grovyle_mask.1bpp.lz"
GrovyleIcon::     INCBIN "gfx/icons/grovyle.2bpp.lz"

SECTION "Sceptile Mini Icon", ROMX
SceptileMini::     INCBIN "gfx/minis/sceptile.2bpp.lz"
